...
export default function IntroduceSection() {
    return (
        <section id="home" className="py-32 sm:py-32 bg-background dark:bg-backgroundDark">
            <h3 className="text-textTitle dark:text-textTitleDark mx-auto mt-2 max-w-lg text-pretty text-center text-4xl font-medium tracking-tight sm:text-5xl pb-24">Le cabinet</h3>
            <div className="text-textPar dark:text-textParDark mx-auto max-w-7xl grid gap-x-32 gap-y-20 px-6 lg:px-8 lg:grid-cols-2">
                    ...
                    {people.map((person) => (
                        <li key={person.name}>
                            <div className="flex flex-col items-center justify-center gap-x-6">
                                ...
                                />
                                <div>
                                    <h3 className="text-base font-semibold leading-7 tracking-tight text-textTitle dark:text-textTitleDark">
                                        {person.name}
                                    </h3>
                                </div>
                            </div>
